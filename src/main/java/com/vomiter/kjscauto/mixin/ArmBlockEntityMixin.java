...
public abstract class ArmBlockEntityMixin {
    ...
    @WrapOperation(method = "collectItem", at = @At(value = "INVOKE", target = "Lcom/simibubi/create/content/kinetics/mechanicalArm/ArmBlockEntity;" +
