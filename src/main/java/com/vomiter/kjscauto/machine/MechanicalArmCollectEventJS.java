...
public class MechanicalArmCollectEventJS  extends LevelEventJS {
    private final Level level;
    private final BlockPos pos;
    private final ArmBlockEntity arm;
    private final BlockPos targetPos;
    private final ItemStack heldItem;
    private ItemStack itemToInteract;
    private BlockContainerJS targetBlock;
    private BlockContainerJS block;
    private boolean cancelled;

    public MechanicalArmCollectEventJS(ArmBlockEntity armBlockEntity, ArmInteractionPoint interactionPoint, ItemStack itemStack, ItemStack itemToCollect){
    ...
    public void setItemToInteract(ItemStack stack) {
        itemToInteract = stack;
    }
